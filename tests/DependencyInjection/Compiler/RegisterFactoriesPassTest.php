...
final class RegisterFactoriesPassTest extends AbstractCompilerPassTestCase
{
    ...
    {
        $this->setParameter('setono_dao.request_factory', 'request_factory_service_id');
        $this->setDefinition('request_factory_service_id', new Definition());

        $this->compile();

        $this->assertContainerBuilderHasAlias('setono_dao.request_factory', 'request_factory_service_id');
    }
    ...
    public function if_request_factory_interface_exists_the_service_alias_exists(): void
    {
        ...
        $this->assertContainerBuilderHasAlias('setono_dao.request_factory', RequestFactoryInterface::class);
    }
    ...
    public function if_nyholms_request_factory_exists_the_service_alias_exists(): void
    {
        ...
        $this->assertContainerBuilderHasAlias('setono_dao.request_factory', 'nyholm.psr7.psr17_factory');
    }
    ...
    public function if_psr17_factory_class_exists_the_service_alias_exists(): void
    {
        ...
        $this->assertContainerBuilderHasAlias('setono_dao.request_factory', 'setono_dao.psr17_factory');
    }
}
